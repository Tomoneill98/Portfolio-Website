    ...
    return (
        <div id="about" className="bg-pastelPurple w-full min-h-screen dark:bg-darkGrey dark:text-white flex justify-center items-center">
             ...
             <h1 className="font-bold text-6xl inline font-mono ">About me</h1>
                <div className="text-sm md:text-lg sm:text-justify my-8 pr-10 " >
                    ...
                    <p className="mb-6 bg-offWhite rounded-lg p-3 md:pr-10 dark:bg-teal-700 font-mono">// I recently completed the Northcoders Software Development Bootcamp, where I gained valuable skills in Agile Methodologies, such as: Scrum, Spiking, and Kanban. Additionally, I worked with other industry-leading practices such as Test-Driven Development, Pair Programming and Version Control. Developing with both front end and back end tech stacks has enabled me to create robust and efficient applications.</p>
