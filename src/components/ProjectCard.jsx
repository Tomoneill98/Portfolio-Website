...
export const ProjectCard = ({ title, description, github, demo, img }) => {
    return (
        <li className="flex-shrink-0 mx-4 relative list-none mb-6 md:w-[400px] md:h-auto lg:w-[500px] lg:h-auto overflow-hidden" style={{ maxWidth: "600px", borderRadius: "15px", }}>
            <img src={img} />

            <div className="absolute inset-0 flex flex-col rounded-2xl justify-center items-center opacity-0 hover:opacity-100 transition-opacity duration-300 bg-pink-200  dark:bg-darkPurple dark:border-2 dark:border-white">
