...
export default function Contact () {
    ...
    return (
  <div id="contact" className="h-[32rem] flex justify-center items-center bg-pastelBlue dark:bg-darkGrey dark:text-white">
    <div className="max-w-[1000px] mx-auto p-4 w-full" >
        ...
        <a target="_blank" href="https://www.linkedin.com/in/tomoneill98/">
            <button className="bg-white dark:bg-teal-700 border-2 p-4 rounded-full mx-10 mb-2">
